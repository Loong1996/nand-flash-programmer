...
| # | 物品 | 数量 | 用途 | 大约价格 |
|---|---|---|---|---|
| C1 | **100 nF 独石电容**（直插，104；X7R，耐压 ≥ 16V，例如 104K 50V；脚距 2.54 mm） | 20 🆕 | 去耦：TSOP48 座 2 个（12↔13、37↔36 脚），每个 SPI 座 VCC 旁 1 个，测试夹 1 个，其余备用 | <¥5 |
| C2 | **10 µF 电容**（直插；铝电解 16V/25V，注意极性：长脚接 3V3；或 106 独石电容，无极性） | 5 | 3V3 电源滤波 | <¥5 |
